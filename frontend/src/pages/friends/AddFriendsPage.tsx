...
const AddFriendsPage = () => {
  ...
  const { data: users, isLoading } = useSearchPlayers(debouncedQuery)
        ...
        <div className="space-y-2">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-slate-400 text-sm font-medium">No players found</p>
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-slate-400 text-sm font-medium">Find players to add</p>
